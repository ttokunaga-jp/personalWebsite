...
type AdminApi = {
  ...
  updateProject: (id: number, payload: ProjectPayload) => ApiClientPromise<AdminProject>;
  ...
  updateResearch: (id: number, payload: ResearchPayload) => ApiClientPromise<AdminResearch>;
  ...
  updateMeeting: (id: number, payload: MeetingPayload) => ApiClientPromise<Meeting>;
  deleteMeeting: (id: number) => ApiClientPromise<void>;

  listBlacklist: () => ApiClientPromise<BlacklistEntry[]>;
  createBlacklist: (payload: BlacklistPayload) => ApiClientPromise<BlacklistEntry>;
...
export const adminApi: AdminApi = {
  ...
  createProject: (payload: ProjectPayload) => apiClient.post<AdminProject>("/admin/projects", payload),
  updateProject: (id: number, payload: ProjectPayload) => apiClient.put<AdminProject>(`/admin/projects/${id}`, payload),
  deleteProject: (id: number) => apiClient.delete<void>(`/admin/projects/${id}`),

  listResearch: () => apiClient.get<AdminResearch[]>("/admin/research"),
  createResearch: (payload: ResearchPayload) => apiClient.post<AdminResearch>("/admin/research", payload),
  updateResearch: (id: number, payload: ResearchPayload) => apiClient.put<AdminResearch>(`/admin/research/${id}`, payload),
  deleteResearch: (id: number) => apiClient.delete<void>(`/admin/research/${id}`),

  listBlogs: () => apiClient.get<BlogPost[]>("/admin/blogs"),
  createBlog: (payload: BlogPayload) => apiClient.post<BlogPost>("/admin/blogs", payload),
  updateBlog: (id: number, payload: BlogPayload) => apiClient.put<BlogPost>(`/admin/blogs/${id}`, payload),
  deleteBlog: (id: number) => apiClient.delete<void>(`/admin/blogs/${id}`),

  listMeetings: () => apiClient.get<Meeting[]>("/admin/meetings"),
  createMeeting: (payload: MeetingPayload) => apiClient.post<Meeting>("/admin/meetings", payload),
  updateMeeting: (id: number, payload: MeetingPayload) => apiClient.put<Meeting>(`/admin/meetings/${id}`, payload),
  deleteMeeting: (id: number) => apiClient.delete<void>(`/admin/meetings/${id}`),

  listBlacklist: () => apiClient.get<BlacklistEntry[]>("/admin/blacklist"),
  createBlacklist: (payload: BlacklistPayload) => apiClient.post<BlacklistEntry>("/admin/blacklist", payload),
  deleteBlacklist: (id: number) => apiClient.delete<void>(`/admin/blacklist/${id}`)
};
