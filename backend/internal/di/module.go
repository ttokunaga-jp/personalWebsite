...
var Module = fx.Module("di",
	fx.Provide(
		...
		provider.NewAdminSessionRepository,
		...
		provider.NewAdminHomePageConfigRepository,
		...
		middleware.NewAdminRateLimiter,
		middleware.NewAdminSessionMiddleware,
